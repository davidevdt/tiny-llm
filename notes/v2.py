...
# hyperparameters 
batch_size = 64
block_size = 256 # maximum context length per prediction 
max_iters = 5000 
eval_interval = 500 
learning_rate = 3e-4
...
eval_iters = 200
n_embed = 384
n_head = 6    # each head is 384 / 6 = 64  
n_layer = 6
dropout = 0.2 
# --------------
...
class Block(nn.Module): 
    ...
    def __init__(self, n_embed, n_head): 
        ...
        self.ln1 = nn.LayerNorm(n_embed) # batch AND time act as normalization dimensions 
...
for iter in range(max_iters): 
    ...
    # evaluate loss on train and val sets every once in a while 
